package com.MReza.HallowKnight.lwjgl3;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setTitle("HollowKnightProject");
        ...
        configuration.setWindowIcon("icons/Program_logo/128.png", "icons/Program_logo/64.png", "icons/Program_logo/32.png", "icons/Program_logo/16.png");
//        configuration.setWindowIcon("icons/Program_logo/16.png","icons/Program_logo/16.png","icons/Program_logo/16.png","icons/Program_logo/16.png");
